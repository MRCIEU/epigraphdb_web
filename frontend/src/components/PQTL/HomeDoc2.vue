<template>
  <div>
    <div>
      ...
      <ul class="list-group">
        <li>
          <strong>Sun,B.B. et al.</strong>
          Genomic atlas of the human plasma proteome.
          <i>Nature</i>
          558, 73–79 (2018)
        </li>
        <li>
          <strong>Emilsson,V. et al.</strong>
          Co-regulatory networks of human serum proteins link genetics to
          disease.
          <i>Science</i>
          361(6404), 769-773 (2018)
        </li>
        <li>
          <strong>Suhre,K. et al.</strong>
          Connecting genetic risk to disease end points through the human blood
          plasma proteome.
          <i>Nat Commun</i>
          8, 14357 (2017)
        </li>
        <li>
          <strong>Folkersen,L. et al.</strong>
          Mapping of 79 loci for 83 plasma protein biomarkers in cardiovascular
          disease.
          <i>PLoS Genet</i>
          13, e1006706 (2017)
        </li>
        <li>
          <strong>Yao,C. et al.</strong>
          Genome-wide mapping of plasma protein QTLs identifies putatively
          causal genes and pathways for cardiovascular disease.
          <i>Nat Commun</i>
          9(1), 3268 (2018)
        </li>
      </ul>
